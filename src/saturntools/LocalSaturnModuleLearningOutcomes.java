 ...
 *
 */
public class LocalSaturnModuleLearningOutcomes {
	/** logger */
    static Logger logger = Logger.getLogger(LocalSaturnModuleLearningOutcomes.class);
	/** main */
	public static void main(String [] args) {
		try {
			...
			for (int argi=0; argi<args.length; argi++) {
				...
				ModuleInfo mi = null;
				try {
					mi = ModuleInfo.processModulePage(null, text, url, false);
				} catch (Exception e) {
